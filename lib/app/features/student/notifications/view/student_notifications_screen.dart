...
class StudentNotificationsScreen extends StatefulWidget {
  ...
  @override
  State<StudentNotificationsScreen> createState() => _NotificationsScreenState();
}

class _NotificationsScreenState extends State<StudentNotificationsScreen> {
  @override
    ...
    return Scaffold( backgroundColor: Colors.white,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            //dynamically pass in notifications from backemd and use icons according to their type
            NotificationWidget(
              body: 'Attendance Recorded',
              image: Assets.purpleBellNotification.path,
              third: Text('2 hours ago'),
              title: 'Your attendance has been recorded for the class',
            ),
